...
export default function Stack({
  randomRotation = true, // enable randomness
  sensitivity = 200,
  ...
  useEffect(() => {
    ...
    const initialRotations = initialCards.map(() =>
  ...
  if (!cards.length) return null; // avoid SSR mismatch
    ...
    {cards.map((card, index) => (
      ...
      >
        <motion.div
          ...
          animate={{
            rotateZ: (cards.length - index - 1) * 4 + rotations[index],
