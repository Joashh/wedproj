...
export default function Main() {
  ...
  <div
    className="w-full h-[28rem] md:h-[30rem]  relative overflow-hidden "
    style={{
  ...
  <div className="absolute bottom-0 transform translate-y-1/2 z-50 md:pt-15">
   ...
   <div className="flex items-center flex-col flex-1 justify-cente w-full gap-6 pt-25 md:pt-50">
 
  {/* Title */}
 <span className="text-gray-600 font-light text-md   font-libre"> Open Invitation</span>
  
  {/* Arrow Button */}
  <div
    className="flex  justify-center border-gray-300 p-2 bg-white/40 backdrop-blur-xs border rounded-full animate-bounce shadow-md cursor-pointer"
